...
- Analyze profitability across different states
...
- Compared sales performance with the previous year
- Compared profit performance with the previous year
- Examined sales and profit trends over time

Product Analysis

- Compared profitability across products
- Identified high-profit products
- Identified low-profit products
- Analyzed product-level contribution to overall profit

Geographic Analysis

- Analyzed profit across different states
- Identified states with stronger and weaker profitability
- Used geographic visualization to understand regional performance
...
- Profit increased by approximately 48.4% compared with the previous year.
- Returned orders accounted for 5.91% of orders.
- Product profitability varies considerably, with some products contributing significantly more profit than others.
...
3. Which products have the lowest profitability?
4. Which states contribute the most to profit?
5. Which states have weaker profitability?
...
"superstoree.pbix"| Power BI dashboard and data model
"dashboard.png"| Power BI dashboard preview
"model_view.png"| Power BI data model
"table_view.png"| Power BI table/data view
"highest_profit_product.png"| Highest-profit product analysis
"lowest_profit_product.png"| Lowest-profit product analysis
